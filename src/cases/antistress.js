          ...
          <div class={s.inner}>
            ...
            >
              ...
              <WaveObject
                ...
                height={155}
                waves={[
                  { lineWidth: 1, amplitude: -80, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 1, amplitude: -55, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 1, amplitude: -20, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.7)' },
                  { lineWidth: 1, amplitude: 45, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 1, amplitude: 20, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 1, amplitude: 70, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 1, amplitude: 110, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.5)' },
                  { lineWidth: 2, amplitude: 150, wavelength: 150, strokeStyle: 'rgba(212, 222, 218, 0.8)' }
                ]}
              />
            </CenterBlock>
